...
def main():
    ...
    for k in range(Step):
        ...
        control_vector_k_minus_1_ideal = CalcU(control_vector_velocity, dk)

        CalcTruePosition(TruePosition, control_vector_k_minus_1_ideal)

        # Update odometry position with noise
        control_vector_k_minus_1 = CalcPositionWithError(OdoPosition, control_vector_k_minus_1_ideal)
